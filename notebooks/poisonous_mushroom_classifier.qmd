...
```{python}
# Data Validation Check for anomalous relations between features, using training data to avoid data leakage
# First we test for dependence between the features using a chi-squared test for independence
from scipy.stats import chi2_contingency

def perform_chi_square_test(data, feature1, feature2):
    """ performs chi square test between two features with 5% significance level"""
